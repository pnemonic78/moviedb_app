...
object TmdbApi {
    ...
    fun generatePosterUrl(movie: Movie, targetWidth: Int, targetHeight: Int): String? {
        return generatePosterUrl(movie.posterPath, targetWidth, targetHeight)
    }

    fun generatePosterUrl(path: String?, width: Int, height: Int): String? {
    ...
    fun generatePosterUrl(path: String?, size: IntSize): String? =
        generatePosterUrl(path, size.width, size.height)
